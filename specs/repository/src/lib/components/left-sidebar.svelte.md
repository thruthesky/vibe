...
이 파일은 `src/lib/components/left-sidebar.svelte`의 소스 코드를 포함하는 SED 스펙 문서입니다.
...
- 2025-11-18: 홈 좌측 사이드바 리디자인 및 정렬 필드 `sort_recentWithPhotos` 적용
- 2025-11-15: 스펙 문서 생성
