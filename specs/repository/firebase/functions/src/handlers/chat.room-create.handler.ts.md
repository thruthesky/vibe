---
title: chat.room-create.handler.ts - TypeScript 소스 코드
original_path: firebase/functions/src/handlers/chat.room-create.handler.ts
...
# chat.room-create.handler.ts

## 개요

**원본 경로**: `firebase/functions/src/handlers/chat.room-create.handler.ts`
