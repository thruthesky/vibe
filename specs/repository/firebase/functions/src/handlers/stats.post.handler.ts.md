---
title: stats.post.handler.ts - TypeScript 소스 코드
original_path: firebase/functions/src/handlers/stats.post.handler.ts
...
# stats.post.handler.ts

## 개요

**원본 경로**: `firebase/functions/src/handlers/stats.post.handler.ts`
