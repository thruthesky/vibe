---
title: authwelcomemessage2.js - JavaScript 소스 코드
original_path: src/paraglide/messages/authwelcomemessage2.js
category: source
file_type: js
status: current
...
# authwelcomemessage2.js

## 개요

**원본 경로**: `src/paraglide/messages/authwelcomemessage2.js`
