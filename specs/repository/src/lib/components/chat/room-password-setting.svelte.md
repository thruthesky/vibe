---
title: room-password-setting.svelte
type: component
path: src/lib/components/chat/room-password-setting.svelte
status: active
version: 1.0.0
...
이 파일은 `src/lib/components/chat/room-password-setting.svelte`의 소스 코드를 포함하는 SED 스펙 문서입니다.
