---
title: testuserdeleteallconfirmation4.js - JavaScript 소스 코드
original_path: src/paraglide/messages/testuserdeleteallconfirmation4.js
category: source
file_type: js
status: current
...
# testuserdeleteallconfirmation4.js

## 개요

**원본 경로**: `src/paraglide/messages/testuserdeleteallconfirmation4.js`
