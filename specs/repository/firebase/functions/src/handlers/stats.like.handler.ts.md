---
title: stats.like.handler.ts - TypeScript 소스 코드
original_path: firebase/functions/src/handlers/stats.like.handler.ts
...
# stats.like.handler.ts

## 개요

**원본 경로**: `firebase/functions/src/handlers/stats.like.handler.ts`
