...
const zh_products = /** @type {(inputs: {}) => string} */ () => {
	return `产品`
};

/** @type {(inputs: {}) => string} */
const en_products = () => 'products'

/** @type {(inputs: {}) => string} */
const ko_products = en_products;

/** @type {(inputs: {}) => string} */
const ja_products = en_products;
...
export const products = (inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_products(inputs)
	if (locale === "ko") return ko_products(inputs)
	if (locale === "ja") return ja_products(inputs)
