---
title: room-password-prompt.svelte
type: component
path: src/lib/components/chat/room-password-prompt.svelte
status: active
version: 1.0.0
...
이 파일은 `src/lib/components/chat/room-password-prompt.svelte`의 소스 코드를 포함하는 SED 스펙 문서입니다.
