...
// Select 컴포넌트
// Radix UI의 Select를 기반으로 한 드롭다운 선택 컴포넌트입니다.
// 접근성을 고려한 키보드 네비게이션과 검색 기능을 제공합니다.
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm text-slate-900 outline-none hover:bg-slate-100 focus:bg-slate-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
