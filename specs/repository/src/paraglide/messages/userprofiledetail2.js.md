---
title: userprofiledetail2.js - JavaScript 소스 코드
original_path: src/paraglide/messages/userprofiledetail2.js
category: source
file_type: js
status: current
...
# userprofiledetail2.js

## 개요

**원본 경로**: `src/paraglide/messages/userprofiledetail2.js`
