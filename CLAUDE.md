...
- [ ] **5단계**: UTF-8 인코딩 검증 (문서/코드 수정/생성 시 필수!) ⚠️ **배포 완료 후 실행**
  - **⚡ 배포가 완료된 후 진행합니다**
...
- [ ] **6단계**: 최종 변경사항 커밋 및 푸시 ⚠️ **UTF-8 확인 후 실행**
...
- [ ] **8단계**: 빌드 날짜/버전 업데이트 ⚠️ **개발자가 명시적으로 요청한 경우에만 실행**
