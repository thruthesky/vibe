...
**파일**: `firebase/functions/src/handlers/post-ranking.handler.ts`
...
**파일**: `src/lib/functions/post.functions.ts`
...
**파일**: `src/routes/post/popular/+page.svelte`
...
**파일**: `src/lib/components/sidebar/PopularPostsCard.svelte`
...
**Cloud Functions:**
- [firebase/functions/src/handlers/post.create.handler.ts](../firebase/functions/src/handlers/post.create.handler.ts)
  ```typescript
  // 음수 타임스탬프 사용
...
- [firebase/functions/src/handlers/chat.message-category.handler.ts](../firebase/functions/src/handlers/chat.message-category.handler.ts)
  ```typescript
  // 채팅 메시지를 게시글로 변환할 때
...
**Shared Library:**
- [shared/categories.ts](../shared/categories.ts)
  ```typescript
...
- [firebase/functions/src/handlers/post-ranking.handler.ts](../firebase/functions/src/handlers/post-ranking.handler.ts)
- [firebase/functions/src/index.ts](../firebase/functions/src/index.ts) (lines 1628-1697)

### 12.2 Frontend (Client)

- [src/lib/functions/post.functions.ts](../src/lib/functions/post.functions.ts)
- [src/routes/post/popular/+page.svelte](../src/routes/post/popular/+page.svelte)
- [src/lib/components/sidebar/PopularPostsCard.svelte](../src/lib/components/sidebar/PopularPostsCard.svelte)
- [src/lib/components/right-sidebar.svelte](../src/lib/components/right-sidebar.svelte)

### 12.3 Database & Security

- [firebase/database.rules.json](../firebase/database.rules.json) (post-rankings section)
